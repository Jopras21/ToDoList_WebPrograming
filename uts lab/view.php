...
<body class="font-sans bg-gray-900 flex items-center justify-center min-h-screen">
    <div class="bg-gray-800 shadow-md rounded-lg p-6 w-full max-w-md">
        <h1 class="text-3xl font-bold mb-4 text-gray-200"><?= htmlspecialchars($todo['title']) ?></h1>
        <p class="text-gray-300 mb-2"><strong>Description:</strong> <?= htmlspecialchars($todo['description']) ?></p>
        <p class="text-gray-300 mb-4"><strong>Created at:</strong> <?= htmlspecialchars($todo['created_at']) ?></p>
